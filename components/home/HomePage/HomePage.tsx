...
const HomePage = () => {
  return (
    <>
      ...
      <main className='pt-6 lg:col-span-9 xl:col-span-10'>
        <div className='overflow-hidden lg:relative'>
          <div className='max-w-md px-4 mx-auto sm:max-w-3xl sm:px-0 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24'>
            <div>
              <div className=''>
                <div>
                ...
                <div className='mt-12 sm:max-w-lg sm:w-full sm:flex'>
                  <div className='mt-4 sm:mt-0'>
                    <button
                      type='button'
                      className='block w-full px-5 py-3 text-base font-medium bg-white border border-transparent rounded-md shadow text-rose-500 hover:bg-rose-100 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:px-10'
                    >
                      Try Demo
                    </button>
                  </div>
